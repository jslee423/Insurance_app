...
//    }
    ...
    @GetMapping("/charge")
    public String chargePage(@RequestParam Long planId, Model model) throws StripeException {
        model.addAttribute("stripePublicKey", API_PUBLIC_KEY);
        
        model.addAttribute("plan", insuranceClient.findPlanById(planId));
        
        String customerId = stripeService.findCustomer("tests@gmail.com");
